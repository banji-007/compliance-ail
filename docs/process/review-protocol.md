...
No phase is scheduled whose exit criterion is not on the path to the roadmap's definition of done (`docs/plan/ail-roadmap.md` §4), unless it is Blocking under the triage rule.
